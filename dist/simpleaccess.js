...
class DsHeader extends HTMLElement {
  connectedCallback() {
    ...
    const headingMarkup = isSubpage
      ...
      : `<h1 class="l-header__title" style="margin-top: 0; font-size: 2.25rem;">${this.escape(title)}</h1>`;

    this.innerHTML = `
      <header class="l-header">
        ${headingMarkup}
        <p class="l-header__tagline" style="margin: 0.5rem 0 0 0; opacity: 0.9;">${this.escape(tagline)}</p>
      </header>
    `;
  }
  ...
  connectedCallback() {
    this.innerHTML = `
      <footer class="l-footer">
        <p>&copy; 2026 <a href="https://thirstyhead.com/">Scott Davis</a>. Built with standard HTML5, SMACSS, and W3C Design Tokens.</p>
